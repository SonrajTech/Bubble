...
class BubbleView extends View {
    ...
    private final List<BubbleBaby> mBubbleBabyList = new ArrayList<>();
    private final List<ValueAnimator> mAnimatorList = new ArrayList<>();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (BubbleBaby bubbleBaby : mBubbleBabyList){
            ...
            mBubblePaint.setAlpha((int) (255 - 255 * (bubbleBaby.scale - INITIAL_SCALE)));
            if (radius > 0) {
    ...
    private static class BubbleBaby{
        int x;
        int y;
